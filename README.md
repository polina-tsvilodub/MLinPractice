...
- `-emb_h`or `--hashtag`: Compute a 25-dimensional GloVe embedding for each hashtag in the "hashtag" column of the data frame. (see code/feature_extraction/embeddings.py)

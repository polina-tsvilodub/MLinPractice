...
- `-sw` or `--stopwords`: A new column "tweet_no_stoopwords" is created, where all stopwords are removed from the tokenized tweet (See `code/preprocessing/stopword_remover.py` for more details)
